...
# Cost tracking removed (see commits from 2026-07-01): fixture-based
# turn.completed.usage → USD tests deleted along with harness.usage,
# schema/model-prices.json, and adapter cost_usd output field.
